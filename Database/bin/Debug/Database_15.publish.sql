...
GO
PRINT N'Altering [dbo].[Reset]...';


GO
ALTER TABLE [dbo].[Reset] ALTER COLUMN [ResetDate] DATETIME NULL;


GO
ALTER TABLE [dbo].[Reset]
    ADD [ResetHartie]  DATETIME NULL,
        [ResetSticla]  DATETIME NULL,
        [ResetMetal]   DATETIME NULL,
        [ResetPlastic] DATETIME NULL;
