...
GO
PRINT N'Dropping [dbo].[FK_WasteOrder_Comanda]...';


GO
ALTER TABLE [dbo].[WasteOrder] DROP CONSTRAINT [FK_WasteOrder_Comanda];


GO
PRINT N'Dropping [dbo].[FK_WasteOrder_Waste]...';


GO
ALTER TABLE [dbo].[WasteOrder] DROP CONSTRAINT [FK_WasteOrder_Waste];
