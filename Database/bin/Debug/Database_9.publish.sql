...
GO
PRINT N'Rename refactoring operation with key 4ce9073d-a589-4a7a-a3f8-57336ec3a3b4 is skipped, element [dbo].[WasteOrder].[Id] (SqlSimpleColumn) will not be renamed to OrderId';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4ce9073d-a589-4a7a-a3f8-57336ec3a3b4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4ce9073d-a589-4a7a-a3f8-57336ec3a3b4')
